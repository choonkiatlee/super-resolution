...
div2k_train = DIV2K(scale=scale, subset='train', downgrade=downgrade, make_input_img_bw=True)
div2k_valid = DIV2K(scale=scale, subset='valid', downgrade=downgrade, make_input_img_bw=True)
